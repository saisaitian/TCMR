...
* <div style="color:blue">**Signature Search Module: 5 signaturesearch methods(ss_xx series) to calculate similarity between TCM profiles and input geneset or profiles**</div> 
    ...
    * `tcm.SSwithCoreGx()`: Correlation-based similarity metrics, such as Spearman or Pearson coefficients, can also be used as GESS methods
</br>
...
```{r, eval=TRUE}
CoreGx_kk <- tcm.SSwithCoreGx(query, data_logFC[1:20])
